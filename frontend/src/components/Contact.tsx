      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1 space-y-6">
            {/* Phone Card */}
            <div className="glass-panel p-8 rounded-2xl border border-border bg-gradient-to-br from-surface to-transparent">
              ...
              <div className="space-y-2">
                <a
                  ...
                  className="text-xl font-extrabold text-text hover:text-primary transition-colors block"
                >
                  {DEALERSHIP_DETAILS.phone}
                </a>
                <a
                  href={`tel:${DEALERSHIP_DETAILS.mobile}`}
                  className="text-sm font-semibold text-textMuted hover:text-text transition-colors block"
                >
            ...
            <div className="glass-panel p-8 rounded-2xl border border-border bg-gradient-to-br from-surface to-transparent">
              <div className="w-12 h-12 bg-surfaceHighlight rounded-xl flex items-center justify-center mb-6 border border-border">
                <Calendar className="text-text" size={24} />
              </div>
              <h3 className="text-xl font-semibold text-text mb-2">Book Workshop</h3>
              <p className="text-textMuted text-xs mb-4">
                Schedule a service, diagnostics, or MOT inspection.
              </p>
              <a
                href="#/servicing"
                className="border border-border text-text hover:bg-surfaceHighlight px-6 py-3 rounded-xl font-semibold transition-colors w-full text-center block"
              >
                Book Workshop Slot
              </a>
            </div>
          ...
          {/* Map and Hours */}
          <div className="lg:col-span-2 glass-panel rounded-2xl overflow-hidden flex flex-col border border-border">
            <div className="h-64 md:h-96 w-full bg-black relative">
              ...
              <iframe
                ...
                loading="lazy"
              />
              <div className="absolute bottom-4 left-4 bg-background/90 backdrop-blur-md p-4 rounded-xl border border-border flex items-center gap-3 shadow-2xl">
                <div className="w-10 h-10 bg-primary rounded-full flex items-center justify-center shrink-0">
                  <MapPin className="text-white" size={20} />
                </div>
                <div>
                  <p className="font-bold text-text text-sm">{DEALERSHIP_DETAILS.name}</p>
            ...
            <div className="p-8 grid grid-cols-1 md:grid-cols-2 gap-8 bg-surface/50">
              <div>
                <h4 className="text-text font-semibold mb-4 flex items-center gap-2 text-sm uppercase tracking-wider">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="mt-4 inline-block text-xs font-semibold text-text hover:text-primary transition-colors underline decoration-text/30 underline-offset-4"
                >
